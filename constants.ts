...
export const TRANSLATIONS = {
  RU: {
    ...
    stopConfirmDesc: 'Вы уверены, что хотите закончить маршрут?',
    yes: 'ДА',
    no: 'НЕТ',
    gpsOn: 'GPS: ВКЛ',
    gpsOff: 'GPS: ВЫКЛ',
  ...
  EN: {
    ...
    start: 'LET\'S GO (START)',
    correct: 'I AM HERE (CORRECT)',
    stop: 'STOP',
    ...
    stopConfirmDesc: 'Are you sure you want to stop tracking?',
    yes: 'YES',
    no: 'NO',
    gpsOn: 'GPS: ON',
    gpsOff: 'GPS: OFF',
